...
export default function YalaPackagesPage() {
    return (
        <div className="bg-background-dark text-white font-display antialiased selection:bg-primary selection:text-background-dark scroll-smooth">
            {/* Hero Section */}
            <section className="relative h-[85vh] min-h-[600px] w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-primary/20 text-primary text-xs font-bold uppercase tracking-wider mb-6 border border-primary/20">Official 2025 Packages</span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a className="flex items-center justify-center h-12 px-8 bg-primary text-background-dark font-bold rounded-lg hover:bg-white transition-colors" href="#packages">
                            View 2025 Packages
                        </a>
            ...
            {/* Sticky Package Nav */}
            <div className="sticky top-16 z-40 bg-surface-dark border-b border-border-dark w-full overflow-x-auto hide-scrollbar">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex whitespace-nowrap min-w-full md:justify-center gap-1">
                        <a className="px-4 py-3 text-sm font-medium text-primary border-b-2 border-primary" href="#private-all">Private All-Inclusive</a>
            ...
            <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto" id="packages">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {/* Card 1 */}
                    <a className="group relative flex flex-col justify-end h-80 rounded-xl overflow-hidden border border-border-dark hover:border-primary transition-colors cursor-pointer" href="#private-all">
                    ...
                    {/* Card 2 */}
                    <a className="group relative flex flex-col justify-end h-80 rounded-xl overflow-hidden border border-border-dark hover:border-primary transition-colors cursor-pointer" href="#shared-all">
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10"></div>
                        <Image
                    ...
                    {/* Card 3 */}
                    <a className="group relative flex flex-col justify-end h-80 rounded-xl overflow-hidden border border-border-dark hover:border-primary transition-colors cursor-pointer" href="#private-jeep">
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10"></div>
                        <Image
                    ...
                    {/* Card 4 */}
                    <a className="group relative flex flex-col justify-end h-80 rounded-xl overflow-hidden border border-border-dark hover:border-primary transition-colors cursor-pointer" href="#shared-jeep">
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10"></div>
                        <Image
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex-1">
                            ...
                            <button className="w-full sm:w-auto bg-primary text-background-dark font-bold py-3 px-8 rounded-lg hover:bg-white transition-colors">
                                Book Private Safari
                            </button>
                        </div>
                        {/* Table */}
                                    ...
                                    <table className="w-full text-left text-sm">
                                        ...
                                        <tbody className="divide-y divide-border-dark">
                                            <tr className="hover:bg-white/5 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-primary font-bold">$105</td>
                                            </tr>
                                            <tr className="hover:bg-white/5 transition-colors">
                                            ...
                                            <tr className="hover:bg-white/5 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-primary font-bold">$190</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            <section className="py-20 bg-background-dark" id="shared-all">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row-reverse gap-12">
                        ...
                        <div className="flex-1">
                            ...
                            <button className="w-full sm:w-auto bg-surface-dark border border-primary text-primary font-bold py-3 px-8 rounded-lg hover:bg-primary hover:text-background-dark transition-colors">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="bg-surface-dark rounded-lg p-6 border border-border-dark mb-6">
                                <div className="flex justify-between items-center mb-3 border-b border-border-dark pb-3">
                                    <span className="text-white font-medium">Half Day Hire</span>
                                    <span className="text-primary font-bold text-lg">$45 <span className="text-xs text-gray-500 font-normal">/ jeep</span></span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-white font-medium">Full Day Hire</span>
                                    <span className="text-primary font-bold text-lg">$85 <span className="text-xs text-gray-500 font-normal">/ jeep</span></span>
                                </div>
                            </div>
                            <button className="w-full bg-surface-dark border border-gray-600 text-white font-bold py-3 px-8 rounded-lg hover:border-primary hover:text-primary transition-colors">
                                Hire Private Jeep
                            </button>
                        </div>
                        {/* Shared Jeep */}
                        <div className="flex flex-col h-full border-t lg:border-t-0 lg:border-l border-border-dark lg:pl-16 pt-12 lg:pt-0" id="shared-jeep">
                            <div className="flex items-center gap-3 mb-4">
                                <span className="bg-primary/10 text-primary p-2 rounded-lg">
                                    <span className="material-symbols-outlined">event_seat</span>
                                </span>
                            ...
                            <div className="bg-surface-dark rounded-lg p-6 border border-border-dark mb-6">
                                <div className="flex justify-between items-center mb-3 border-b border-border-dark pb-3">
                                    ...
                                    <span className="text-primary font-bold text-lg">$12 <span className="text-xs text-gray-500 font-normal">/ person</span></span>
                                </div>
                                <div className="flex justify-between items-center">
                    ...
                    <div className="bg-red-900/10 border border-red-900/50 rounded-xl p-6 md:p-8 flex flex-col md:flex-row gap-6 items-start">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                <span className="inline-flex items-center gap-1 px-3 py-1 rounded bg-surface-dark text-xs text-gray-300 border border-border-dark">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="bg-background-dark p-6 rounded-xl border border-border-dark">
                            ...
                            <p className="text-primary text-sm font-bold">Rec: Private All-Inclusive</p>
                        </div>
                        {/* Persona 2 */}
                        <div className="bg-background-dark p-6 rounded-xl border border-border-dark">
                            <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center text-primary mb-4">
                        ...
                        <div className="bg-background-dark p-6 rounded-xl border border-border-dark">
                            ...
                            <p className="text-primary text-sm font-bold">Rec: Shared All-Inclusive</p>
                        </div>
                        {/* Persona 4 */}
                        <div className="bg-background-dark p-6 rounded-xl border border-border-dark">
                            <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center text-primary mb-4">
                            ...
                            <p className="text-primary text-sm font-bold">Rec: Full Day Private</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* Trust & Transparency */}
            <section className="py-16 border-t border-border-dark bg-background-dark">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            {/* Final CTA */}
            <section className="py-24 bg-primary text-background-dark relative overflow-hidden" id="contact">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className="bg-background-dark text-white text-lg font-bold py-4 px-10 rounded-xl hover:bg-black transition-transform hover:-translate-y-1 shadow-lg flex items-center justify-center gap-2">
                            <span className="material-symbols-outlined">chat</span> Book via WhatsApp
                        </button>
                        <button className="bg-white/20 border-2 border-background-dark/20 text-background-dark text-lg font-bold py-4 px-10 rounded-xl hover:bg-white/30 transition-colors">
                            Calculate Cost
                        </button>
                    </div>
                </div>
